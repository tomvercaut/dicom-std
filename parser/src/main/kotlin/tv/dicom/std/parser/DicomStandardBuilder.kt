...
import tv.dicom.std.model.Resource
import tv.dicom.std.model.*
import tv.dicom.std.model.ciod.Ciod
import tv.dicom.std.model.ciod.Entry
import tv.dicom.std.model.dictionary.DataElement
import tv.dicom.std.model.dictionary.RangedTag
import tv.dicom.std.model.dictionary.VR
import tv.dicom.std.model.imd.DataEntry
import tv.dicom.std.model.imd.Imd
import tv.dicom.std.model.imd.IncludeEntry
import java.util.*
 ...
 * @return A [List] of [tv.dicom.std.model.imd.Entry] instances is returned.
 */
 ...
 */
internal fun buildImdEntry(tr: Element): Optional<tv.dicom.std.model.imd.Entry> {
    val otds = tableRowColumns(tr)
    ...
    if (ntds == 1 || ntds == 2) {
        ...
        return Optional.of(entry as tv.dicom.std.model.imd.Entry)
